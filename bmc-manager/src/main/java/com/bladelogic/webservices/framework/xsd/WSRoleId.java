...
public class WSRoleId implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name = WSRoleId
	 * Namespace URI = http://bladelogic.com/webservices/framework/xsd Namespace
	 * Prefix = ns1
	 */
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":WSRoleId", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"WSRoleId", xmlWriter);
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		if (localIdTracker) {
			elementList.add(new javax.xml.namespace.QName(
					"http://bladelogic.com/webservices/framework/xsd", "id"));
		...
		if (localNameTracker) {
			elementList.add(new javax.xml.namespace.QName(
					"http://bladelogic.com/webservices/framework/xsd", "name"));
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static WSRoleId parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			WSRoleId object = new WSRoleId();
			...
			try {
						...
						if (!"WSRoleId".equals(type)) {
							...
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (WSRoleId) com.bladelogic.webservices.skeleton.login.ExtensionMapper
				...
				if (reader.isStartElement()
					...
					object.setRoleId(org.apache.axis2.databinding.utils.ConverterUtil
							.convertToInt(content));
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName(
								"http://bladelogic.com/webservices/framework/xsd",
								"roleName").equals(reader.getName())) {
					...
					if (!"true".equals(nillableValue)
						...
						object.setRoleName(org.apache.axis2.databinding.utils.ConverterUtil
								.convertToString(content));
