/**
 * ExecuteCommandByParamList.java
 *
...
/**
 * ExecuteCommandByParamList bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class ExecuteCommandByParamList implements
		org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://bladelogic.com/webservices/skeleton/clitunnel",
			"executeCommandByParamList", "ns8");
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":executeCommandByParamList",
						xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"executeCommandByParamList", xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static ExecuteCommandByParamList parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			ExecuteCommandByParamList object = new ExecuteCommandByParamList();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"executeCommandByParamList".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (ExecuteCommandByParamList) com.bladelogic.webservices.skeleton.clitunnel.ExtensionMapper
