...
/**
 * LoginUsingUserCredential bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class LoginUsingUserCredential implements
		org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://bladelogic.com/webservices/skeleton/login",
			"loginUsingUserCredential", "ns2");
	...
	public void serialize(final javax.xml.namespace.QName parentQName,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"loginUsingUserCredential", xmlWriter);
			}
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		if (localAuthenticationTypeTracker) {
			...
			elementList.add(localAuthenticationType == null ? null
					: org.apache.axis2.databinding.utils.ConverterUtil
							.convertToString(localAuthenticationType));
		}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static LoginUsingUserCredential parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			LoginUsingUserCredential object = new LoginUsingUserCredential();
			...
			try {
						...
						if (!"loginUsingUserCredential".equals(type)) {
							...
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (LoginUsingUserCredential) com.bladelogic.webservices.skeleton.login.ExtensionMapper
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName(
								"http://bladelogic.com/webservices/skeleton/login",
								"authenticationType").equals(reader.getName())) {
					...
					if (!"true".equals(nillableValue)
						...
						object.setAuthenticationType(org.apache.axis2.databinding.utils.ConverterUtil
								.convertToString(content));
