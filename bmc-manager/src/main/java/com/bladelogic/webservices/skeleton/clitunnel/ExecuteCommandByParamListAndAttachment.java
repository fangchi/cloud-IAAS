/**
 * ExecuteCommandByParamListAndAttachment.java
 *
...
/**
 * ExecuteCommandByParamListAndAttachment bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class ExecuteCommandByParamListAndAttachment implements
		org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://bladelogic.com/webservices/skeleton/clitunnel",
			"executeCommandByParamListAndAttachment", "ns8");
	...
	protected javax.activation.DataHandler localDh;
	 ...
	 */
	public javax.activation.DataHandler getDh() {
		return localDh;
	}
	 ...
	 *            Dh
	 */
	public void setDh(javax.activation.DataHandler param) {
		localDhTracker = true;
	...
	public void serialize(final javax.xml.namespace.QName parentQName,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"executeCommandByParamListAndAttachment", xmlWriter);
			}
			...
			if (localDh != null) {
				try {
					org.apache.axiom.util.stax.XMLStreamWriterUtils
							.writeDataHandler(xmlWriter, localDh, null, true);
				} catch (java.io.IOException ex) {
					throw new javax.xml.stream.XMLStreamException(
							"Unable to read data handler for dh", ex);
				}
			} else {
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static ExecuteCommandByParamListAndAttachment parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			ExecuteCommandByParamListAndAttachment object = new ExecuteCommandByParamListAndAttachment();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"executeCommandByParamListAndAttachment"
								.equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (ExecuteCommandByParamListAndAttachment) com.bladelogic.webservices.skeleton.clitunnel.ExtensionMapper
				...
				if (reader.isStartElement()
					...
					if ("true".equals(nillableValue)
						...
						object.setDh(org.apache.axiom.util.stax.XMLStreamReaderUtils
