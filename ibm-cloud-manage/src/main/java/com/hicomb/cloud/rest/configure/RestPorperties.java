...
public class RestPorperties {
	 ...
	 */
	public static final String PROPERTY_PREFIX = "com.hicomb.rest.";
	...
	private static void loadConfig() {
		try {
			//载入Properties文件
			configProperties.load(RestPorperties.class.getResourceAsStream("ibm-rest.properties"));
		} catch (IOException e) {
			logger.error("未找到ibm-rest.properties");
		}
